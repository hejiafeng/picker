...
//        picker.showAtBottom();
        picker.showAtCenter(findViewById(android.R.id.content));
    }

    public void onYearMonthDay(View view) {
        DateEntity today = DateEntity.today();
        DateTimePicker picker = new DateTimePicker(this, DateMode.YEAR_MONTH_DAY, TimeMode.NONE);
...
//        picker.setWheelStyle(R.style.WheelDateTime_Custom);
        ...
        picker.showAtCenter(findViewById(android.R.id.content));
        TextView titleTextView = picker.getConfirmTextView();
        titleTextView.setTextColor(Color.BLUE);

        picker.getBodyView().setIndicator(true);
        picker.getBodyView().setIndicatorColor(Color.BLUE);

//        picker.getBodyView().setCurtain(true);
//        picker.getBodyView().setCurtainColor(Color.GREEN);
//        picker.getBodyView().setIndicatorSize(ConvertUtils.dp2px(0.6F));
//        picker.showAtCenter();
    }
